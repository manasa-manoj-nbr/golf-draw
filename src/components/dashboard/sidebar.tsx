...
const navItems = [
  ...
  { label: 'Winnings', href: '/dashboard/winnings', icon: Award },
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-50 lg:hidden w-14 h-14 bg-bauhaus-red text-white flex items-center justify-center shadow-bauhaus-sm"
      >
